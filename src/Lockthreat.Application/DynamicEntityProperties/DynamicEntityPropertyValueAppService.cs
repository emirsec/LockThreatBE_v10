...
using Lockthreat.DynamicEntityPropertyValues.Dto;

namespace Lockthreat.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : LockthreatAppServiceBase, IDynamicEntityPropertyValueAppService
    {
