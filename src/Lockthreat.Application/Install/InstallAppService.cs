...
namespace Lockthreat.Install
{
    ...
    public class InstallAppService : LockthreatAppServiceBase, IInstallAppService
    {
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{LockthreatConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{LockthreatConsts.ConnectionStringName}", constring);
        }
